# Applied AI Field Guide plugin security notes
...
- symbolic links in installation and configuration paths, invalid or explicitly missing legacy settings, and workspace/configuration overlap with the replaceable plugin package;
