...
| [Applied AI delivery and operating model](../library/10-applied-ai-delivery-and-operating-model.md) | Keep closed-loop improvement governed and reject cloud or multi-agent choices by category |
