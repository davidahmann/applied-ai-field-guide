...
| Artifact | Change |
| --- | --- |
| [Applied AI delivery and operating model](../library/10-applied-ai-delivery-and-operating-model.md) | Add an owned contribution-path decision and shadow-product boundary |
...
| [Portfolio review](../templates/workflow-portfolio-review.md) | Add unresolved shadow-product and target-specific intervention signals |
