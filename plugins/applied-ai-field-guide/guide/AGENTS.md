...
| Staff one applied-AI workflow | [Capability roadmap staffing view](guide/capability-roadmap.md#staff-the-workflow-you-have) → [delivery and adoption plan](templates/delivery-and-adoption-plan.md#proof-participation-and-decision-capacity) → applicable decision gate | Named skills, decision rights, capacity, delegates, and a narrow, defer, or stop choice when coverage is missing; no fixed team chart |
