...
Use this playbook when a delivery team inherits a customer request, internal mandate, product brief, statement of work, or existing plan. The inherited brief is a hypothesis about the work, not authority, observed truth, or a commitment to automate its proposed solution. Keep commercial promises classified as `sold` and internal requests as `stated`; neither is an observation.
...
The reframe is a proposal. Model output, a delivery-team recommendation, elapsed time, or a funding deadline cannot accept it.
