...
For a linear introduction, read the concise [Applied AI Field Guide](../guide/README.md). This page is the Handbook's design-entry checklist.
...
For an end-to-end customer or internal engagement, use the [delivery playbooks](../playbooks/README.md). This page is the shorter design checkpoint for one workflow.
...
7. Is the system reading, recommending, drafting, or changing an external system?
...
| --- | --- | --- |
| You are leading a field or internal delivery engagement | [Delivery playbooks](../playbooks/README.md) | Field observation, value evidence, adoption, service ownership, and exit criteria |
| You are building reusable applied-AI capability | [Applied AI delivery and operating model](10-applied-ai-delivery-and-operating-model.md) | A clear productization boundary, reusable artifacts, and a governed field-learning loop |
...
| A local slice must cross legacy, restricted, or target-scale boundaries | [Enterprise Integration and Scale Reality](17-enterprise-integration-and-scale-reality.md) | Source authority, extraction, reconciliation, identity, durable execution, promotion, recovery, and target evidence |
...
| --- | --- |
| Field evidence | [Field-observation log](../templates/field-observation-log.md) and [Discovery pack](../templates/discovery-pack.md) |
...
| Service ownership | [Service enablement and handoff](../templates/customer-enablement-handoff.md) |
