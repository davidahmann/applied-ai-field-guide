...
For discovery, value, adoption, and ownership before, around, and after these technical phases, use the [delivery playbooks](../playbooks/README.md). Field evidence and a candidate [workflow charter](../templates/workflow-charter.json) are inputs to Phase 0; an approved charter is required before Phase 1. Exercised operating capability and recurring service review are final outputs, whether the service serves a customer or an internal team.
...
Use the [field-observation log](../templates/field-observation-log.md), [discovery pack](../templates/discovery-pack.md), [workflow charter](../templates/workflow-charter.json), and [value case](../templates/value-case.md).
