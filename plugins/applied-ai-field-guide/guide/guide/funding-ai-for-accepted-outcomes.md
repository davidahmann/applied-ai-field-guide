...
The [invoice-exception engagement](../examples/invoice-exception/engagement/README.md) begins with a fictional sold promise: automatically resolve and post eligible exceptions. Field evidence shows that a reviewer must approve a staged correction before posting.
...
The definitive value framework is the [12 Factors of AI Value Engineering](../library/14-twelve-factors-ai-value-engineering.md). Use its [one-page scorecard](ai-value-engineering-scorecard.md) for a live decision. Then follow the [canonical lifecycle](../README.md#from-idea-to-production) and retain the exact artifacts that justify each transition.
