...
2. Use the [engagement-reframe record](../../../templates/engagement-reframe.json), [field-observation log](../../../templates/field-observation-log.md), and [discovery pack](../../../templates/discovery-pack.md).
