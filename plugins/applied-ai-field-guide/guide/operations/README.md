...
| --- | --- | --- |
| Establish a company adoption operating model | [Operate and Scale](../playbooks/03-operate-and-scale.md#company-operating-model-centralize-rails-preserve-workflow-accountability) and [workflow portfolio review](../templates/workflow-portfolio-review.md) | Named decision rights, shared-versus-workflow capability boundary, temporary delivery substitutions, and proof-to-operation gates |
...
| Review an applied-AI workflow portfolio | [Workflow portfolio review](../templates/workflow-portfolio-review.md) | Cohort-aware investment, continuation, operating ownership, productization, transfer, capacity, or exit decision |
