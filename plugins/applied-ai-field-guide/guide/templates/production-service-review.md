...
Continuation signals route attention and planning. A contract, budget, sponsor, reference, or high usage level does not independently prove an accepted outcome or realized value. If this workflow is part of a multi-service program, link its evidence into the [workflow portfolio review](workflow-portfolio-review.md) without replacing this service-level decision.
