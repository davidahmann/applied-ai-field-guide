...
- **Work with a coding agent:** [AGENTS.md](../AGENTS.md), the optional [task skills](../.agents/skills/), and the private [FDE local plugin](../plugins/fde/README.md) when local engagement continuity is useful.
