...
1. Read [Solution Design and Delivery](../../../playbooks/02-solution-and-delivery.md), the [Production Implementation Playbook](../../../library/07-production-implementation-playbook.md), and the [delivery and adoption plan](../../../templates/delivery-and-adoption-plan.md).
2. Load the approved workflow charter, value case, data-context manifest, intelligence-selection record, architecture decision, and only the selected [solution pattern](../../../solutions/README.md). Read only the artifacts that apply to the chosen mechanism.
