...
description: Establish or run the operating model for production AI-enabled services or a multi-workflow adoption program. Use for decision rights, shared enablement, telemetry, SLOs, incidents, cost, change, service review, scaling, or retirement.
---
...
1. Read factors 11–12 in the [12 Factors of AI Value Engineering](../../guide/library/14-twelve-factors-ai-value-engineering.md), [Operate and Scale](../../guide/playbooks/03-operate-and-scale.md), and the [operations map](../../guide/operations/README.md).
2. Use the [production service review](../../guide/templates/production-service-review.md), [SLO scorecard](../../guide/operations/slo-scorecard.md), [data quality and drift contract](../../guide/operations/data-quality-and-drift.md), [telemetry contract](../../guide/operations/telemetry-contract.md), [behavior monitoring](../../guide/operations/behavior-monitoring.md), [incident runbook](../../guide/operations/incident-runbook.md), and [change management](../../guide/operations/change-management.md). For company adoption or more than one workflow, add the [FDE and applied-AI workflow portfolio review](../../guide/templates/fde-portfolio-review.md); it never replaces a service-level gate.
3. If the service uses a solution artifact, resolve it through the [solution portfolio](../../guide/solutions/README.md) and read only the selected business-flow pattern and optional vertical profile. Use their operating measures as seeds; local denominators, objectives, and owners control.
4. Apply `CTX-009`, `OPS-001` through `OPS-007`, `REL-002` through `REL-004`, `ADP-002`, `CST-001`, and `CST-002` from the [control catalog](../../guide/controls/control-catalog.json).
...
2. For a proof, predeclare maximum duration, evidence cutoff, decision owner, receiving owner, and separate technical, operator, adoption, value, economics, data/risk, and production-readiness gates; decide stop, reshape, continue proving, or bounded production. Require every applicable mandatory gate to pass before bounded production; time-bounded remediation may address only an explicitly non-blocking residual.
...
7. Version and evaluate changes, canary them by route, segment, and effect class, monitor rollback triggers, and preserve compatible release evidence. Expand from observe to recommend, act with approval, or bounded autonomous action only for the evaluated effect class.
