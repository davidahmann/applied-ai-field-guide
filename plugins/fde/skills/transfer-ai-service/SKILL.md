...
1. Read [Solution Design and Delivery](../../guide/playbooks/02-solution-and-delivery.md) and [Operate and Scale](../../guide/playbooks/03-operate-and-scale.md).
2. Use the [delivery and adoption plan](../../guide/templates/delivery-and-adoption-plan.md) and [customer-enablement handoff](../../guide/templates/customer-enablement-handoff.md).
3. If the service uses a solution artifact, resolve it through the [solution portfolio](../../guide/solutions/README.md) and read only the selected business-flow pattern and optional vertical profile. Use customer-specific decisions and operating contracts as checklist inputs, not exercised evidence or acceptance.
4. Apply `ADP-001`, `ADP-002`, `FDE-003`, `DEL-001`, `OPS-002`, `OPS-003`, and `OPS-007` from the [control catalog](../../guide/controls/control-catalog.json).
