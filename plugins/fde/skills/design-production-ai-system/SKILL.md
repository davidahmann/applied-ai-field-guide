...
2. Read [Solution Design and Delivery](../../guide/playbooks/02-solution-and-delivery.md), the [solution portfolio](../../guide/solutions/README.md), the [production implementation playbook](../../guide/library/07-production-implementation-playbook.md), and the [blueprint selector](../../guide/blueprints/README.md).
...
4. Follow the canonical artifact order in [AGENTS.md](../../guide/AGENTS.md).
