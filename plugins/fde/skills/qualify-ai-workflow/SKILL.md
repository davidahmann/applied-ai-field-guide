...
1. Read [Field Engagement and Accountable Reframing](../../guide/playbooks/00-field-engagement-and-reframing.md), the [12 Factors of AI Value Engineering](../../guide/library/14-twelve-factors-ai-value-engineering.md), and the [Discovery and Value playbook](../../guide/playbooks/01-discovery-and-value.md).
2. Use the [field-observation log](../../guide/templates/field-observation-log.md), [discovery pack](../../guide/templates/fde-discovery-pack.md), [engagement-reframe record](../../guide/templates/engagement-reframe.json), [workflow-charter template](../../guide/templates/workflow-charter.json), and [data-readiness assessment](../../guide/templates/data-readiness-assessment.md).
3. Only after observing and bounding the target work, compare it with the [business-flow index](../../guide/solutions/business-flows/README.md). Read only one matching pattern, or record `none`; treat it as a hypothesis rather than field evidence or design approval.
4. Apply `FDE-001` through `FDE-003`, `FDE-005`, `VAL-001`, `VAL-003`, `CTX-001`, and `CTX-006` through `CTX-008` from the [control catalog](../../guide/controls/control-catalog.json).
