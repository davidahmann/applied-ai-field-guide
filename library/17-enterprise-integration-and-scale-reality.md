...
This chapter connects the Guide's clean contracts to that deployment reality. It does not prescribe a universal enterprise stack. It shows what an FDE must observe, preserve, and prove before a teaching implementation or narrow slice can support a target-system claim.
