...
| [Field observation log](../templates/field-observation-log.md) and [discovery pack](../templates/fde-discovery-pack.md) | Record the interaction boundary and capture receipt without creating a new artifact system |
