...
| [`examples/`](examples/invoice-exception/README.md) | Shows a complete synthetic invoice engagement, controlled-write and retrieval systems, and an end-to-end applied-AI walkthrough | Worked decision chains, in-memory teaching implementations, and regression surfaces—not customer proof |
...
| Practice without customer access | [Invoice practice packet](examples/invoice-exception/document-review/practice.md) → [document-review lab](examples/invoice-exception/document-review/README.md) or [retrieval-evaluation lab](examples/invoice-exception/retrieval-evaluation/README.md) → existing worked engagement | Source checking, correction, retrieval evaluation, economic and ownership decisions over fictional inputs; no posting authority or measured customer benefit |
